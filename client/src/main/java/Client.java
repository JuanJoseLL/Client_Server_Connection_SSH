    ...
    public static void main(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator communicator = com.zeroc.Ice.Util.initialize(args, "config.client", extraArgs)) {
            ...
            while (flag) {
                ...
                System.out.println("1. Send a message (also to exit)");
                System.out.println("2. Test Throughput");
                System.out.println("3. Test Response Time");
                System.out.println("4. Test Missing Rate");
                System.out.println("5. Test Unprocessed Rate");
                ...
                switch (choice) {
                    case 1:
                        ...
                        if(sendMessage(twoway,sc)==false){
                            flag = false;
                        }
                        break;
                    case 2:
                        testThroughput(twoway, sc);
                        break;
                    case 3:
                        testResponseTime(twoway, sc);
                        break;
                    case 4:
                        testMissingRate(twoway, sc);
                        break;
                    case 5:
                        testUnprocessedRate(twoway, sc);
                        break;
                    default:
